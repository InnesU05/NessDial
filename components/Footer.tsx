  ...
  return (
    <footer className="bg-slate-900 text-white pt-8 md:pt-16 pb-8 relative">
       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between text-center md:text-left shadow-2xl border border-blue-500">
              ...
              <button 
                ...
                className="bg-white text-blue-700 font-bold py-3 px-8 rounded-full hover:bg-slate-50 transition-colors shadow-lg flex items-center transform hover:-translate-y-0.5"
              >
                Get Started
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-slate-100">Quick Links</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 text-slate-100">Contact</h4>
            <ul className="space-y-3 text-slate-400">
              <li className="flex items-center group">
                <Mail className="h-5 w-5 mr-3 text-blue-500 group-hover:text-blue-400 transition-colors" />
                <a href="mailto:nessdialai@gmail.com" className="hover:text-white transition-colors">nessdialai@gmail.com</a>
              </li>
              <li className="flex items-center group">
                <Phone className="h-5 w-5 mr-3 text-blue-500 group-hover:text-blue-400 transition-colors" />
                <a href="tel:+4407986019065" className="hover:text-white transition-colors">(+44) 07986019065</a>
              </li>
